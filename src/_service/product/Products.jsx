...
export default class ServiceProducts extends Component {
  ...
  componentDidMount(){
    axios.get('http://localhost:8000/service/products', {
    ...
    <main className='flex-1'>
      <div className='mr-3'>
        <div className='flex items-center justify-between py-5 px-10'>
          ...
          <Link to='/service/products/create'>
        ...
        {products.map(item => (
          ...
          className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td scope="row" className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">{item.amount}</td>
					</tr>
          ))}
				</tbody>
			  </table>
